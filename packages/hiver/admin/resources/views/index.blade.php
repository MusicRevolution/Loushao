...
<body class="site-contabs-open site-menubar-unfold" id="navbarSlide">
    ...
    <nav class="contabs" id="page-tab">
        <button type="button" class="btn btn-icon btn-default" id="page-prev">
            <i class="fa fa-angle-double-left"></i>
        </button>
        <nav class="contabs-scroll">
            <div id="page-tab-content">
                <div id="menu-list" class="nav con-tabs">
                    <a href="javascript:void(0);" data-url="{{ url('/admin/welcome') }}" data-value="控制面板" class="active" id="home">控制面板</a>
                </div>
            </div>
         </nav>
        <div class="btn-group">
            <button type="button" class="btn btn-icon btn-default" id="page-next">
                <i class="fa fa-angle-double-right"></i>
            </button>
            <div class="btn btn-default dropdown-toggle btn-outline" id="page-operation" data-toggle="dropdown" data-animation="slide-bottom" aria-expanded="true" role="button">
                <span class="caret"></span>
                <span class="sr-only">切换菜单</span>
            </div>
            <ul class="dropdown-menu page-tab-operation" role="menu">
    ...
    <main class="site-page" id="page-content">
        <iframe class="iframe-content active" data-url="{{ url('/admin/welcome') }}" data-value="控制面板" src="{{ url('/admin/welcome') }}"></iframe>
    </main>
